<template>
  <div class="meta-wrapper">
    <div class="meta-item original">
      <a-tag v-if="isOriginal" color="orangered" title="original">
        <template #icon>
          <icon-trophy />
        </template>
        Original
      </a-tag>
      <a-tag v-else color="arcoblue" title="Shared">
        <template #icon>
          <icon-share-alt />
        </template>
        Shared
    ...
    <div class="meta-item">
      ...
      <span class="meta-content">
        <a v-if="isOriginal" :href="authorLink" title="Auther Home Page">{{ author }}</a>
    ...
    <div class="meta-item">
      <span class="meta-icon date">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          <title v-if="isOriginal">Published at</title>
          <title v-else>Shared at</title>
    ...
    <div class="meta-item" v-if="showCategory">
      <span class="meta-icon category">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>Category</title><path d="M928 444H820V330.4c0-17.7-14.3-32-32-32H473L355.7 186.2a8.15 8.15 0 0 0-5.5-2.2H96c-17.7 0-32 14.3-32 32v592c0 17.7 14.3 32 32 32h698c13 0 24.8-7.9 29.7-20l134-332c1.5-3.8 2.3-7.9 2.3-12 0-17.7-14.3-32-32-32zM136 256h188.5l119.6 114.4H748V444H238c-13 0-24.8 7.9-29.7 20L136 643.2V256z m635.3 512H159l103.3-256h612.4L771.3 768z"></path></svg>
      </span>
      <span class="meta-content">
