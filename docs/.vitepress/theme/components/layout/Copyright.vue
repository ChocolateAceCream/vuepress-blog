  ...
  <div class="copyright">
    <div class="content">
      <div class="item">
        ...
        <span>Copyright: </span>
        <span>
          <a v-if="isOriginal" :href="authorLink" title="About Auther" target="_blank">{{ author }}</a>
      ...
      <div class="item">
        ...
        <span v-if="isOriginal">Link: </span>
        <span v-else>Origin Article: </span>
        <span>
      ...
      <div v-if="isOriginal" class="item">
        ...
        <span>Work Licensed under: </span>
        <span>《<a :href="theme.copyrightConfig.licenseLink" target="_blank">{{ theme.copyrightConfig.license }}</a>》license</span>
      </div>
    </div>
  </div>
</template>
